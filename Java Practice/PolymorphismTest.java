...
public class PolymorphismTest {
  ...
  public static void main(String[] args) {
    ...
    BasePlusCommissionEmployee basePlusCommissionEmployee = new BasePlusCommissionEmployeeC("Bob", "Lewis", "333-33-333", 5000, .04, 300);
    ...
    System.out.printf("%s %s:%n%n%s%n", "Call BasePlusCommissionEmployee's toString with superclass", "refernce to subclass object", commissionEmployee2.toString());
  }
}
