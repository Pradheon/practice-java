...
public class Student {
  ...
  //create and test Student objectives
  ...
  //constructor inititializes instance varaibles
  public Student(String name, double average) {
    ...
    if (average > 0.0) {
      if (average <= 100.0) {
        this.average = average; //assigm to instance variable
      }
    }
  }
  ...
  public void setAverage(double studentAverage) {
    //validate that average is > 0.0 and <= 100.0; otherwise, keep instance variable average's current value (0.0)
    if (average > 0.0) {
      if (average <= 100.0) {
  ...
  //deternubes and returns the Student's letter grade
